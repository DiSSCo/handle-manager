...
class FdoRecordServiceTest {
  ...
  static {
    ADMIN_HANDLE = new HandleAttribute(100, HANDLE.getBytes(StandardCharsets.UTF_8),
        HS_ADMIN.get(),
  ...
  void testPrepareDigitalMediaAttributesOptional() throws Exception {
    ...
    var request = new DigitalMediaRequest(ISSUED_FOR_AGENT_TESTVAL, PID_ISSUER_TESTVAL_OTHER,
        ...
        LINKED_DIGITAL_OBJECT_TYPE_TESTVAL,
  ...
  void testPrepareDigitalMediaFullAttributes() throws Exception {
    ...
    var request = new DigitalMediaRequest(ISSUED_FOR_AGENT_TESTVAL, PID_ISSUER_TESTVAL_OTHER,
        ...
        LINKED_DIGITAL_OBJECT_TYPE_TESTVAL, "a", "b", PrimarySpecimenObjectIdType.GLOBAL,
        "d",
  ...
  void testPrepareDigitalSpecimenRecordMandatoryAttributesQNumber() throws Exception {
    ...
    var request = new DigitalSpecimenRequest(ISSUED_FOR_AGENT_TESTVAL, PID_ISSUER_TESTVAL_OTHER,
        LOC_TESTVAL, REFERENT_NAME_TESTVAL, PRIMARY_REFERENT_TYPE_TESTVAL, qid, null,
        "PhysicalId",
        null, null, NORMALISED_PRIMARY_SPECIMEN_OBJECT_ID_TESTVAL, null, null, null, null,
        null,
  ...
  void testPrepareDigitalSpecimenRecordMandatoryAttributesBadSpecimenHost() throws Exception {
    ...
    var request = new DigitalSpecimenRequest(ISSUED_FOR_AGENT_TESTVAL, PID_ISSUER_TESTVAL_OTHER,
        ...
        "PhysicalId", null, null, NORMALISED_PRIMARY_SPECIMEN_OBJECT_ID_TESTVAL, null, null,
        null,
  ...
  void testPidIssuerBad() throws Exception {
    // Given
    given(pidResolver.getObjectName(any())).willReturn("placeholder");
    var request = new HandleRecordRequest(ISSUED_FOR_AGENT_TESTVAL, "abc",
  ...
  void testBadRor() throws Exception {
    // Given
    given(pidResolver.getObjectName(any())).willReturn("placeholder");
    var request = new HandleRecordRequest("abc", ISSUED_FOR_AGENT_TESTVAL,
        STRUCTURAL_TYPE_TESTVAL,
        null);
