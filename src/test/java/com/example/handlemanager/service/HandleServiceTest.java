...
import static com.example.handlemanager.testUtils.TestUtils.CREATED;
import static com.example.handlemanager.testUtils.TestUtils.HANDLE;
import static com.example.handlemanager.testUtils.TestUtils.HANDLE_ALT;
import static com.example.handlemanager.testUtils.TestUtils.PTR_HANDLE_RECORD;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenBotanyRecord;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenBotanyRequest;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenBotanyResponse;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenRecord;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenRequest;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDigitalSpecimenResponse;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDoiRecord;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDoiRequest;
import static com.example.handlemanager.testUtils.TestUtils.generateTestDoiResponse;
import static com.example.handlemanager.testUtils.TestUtils.generateTestHandleRecord;
import static com.example.handlemanager.testUtils.TestUtils.generateTestHandleRequest;
import static com.example.handlemanager.testUtils.TestUtils.generateTestHandleResponse;
...
class HandleServiceTest {
  ...
  void CreateDigitalSpecimenBotanyTest()
    ...
    DigitalSpecimenBotanyResponse response_expected = generateTestDigitalSpecimenBotanyResponse(
        handle);
